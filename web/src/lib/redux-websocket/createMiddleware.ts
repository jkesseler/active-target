...
import type { Action, ReduxWebSocketOptions } from './types';
 ...
 * @private
 */
const defaultOptions: ReduxWebSocketOptions = {
  dateSerializer: null,
...
export default (rawOptions?: ReduxWebSocketOptions): Middleware => {
