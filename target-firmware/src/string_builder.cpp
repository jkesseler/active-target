...
String MessageFormatter::createSensorMessage(const char *type, const char *zone, int value) {
  StringBuilder sb(128);
  sb.append(type).append(" on zone ").append(zone).append(" with value: ").append(value);
  return sb.toString();
}
